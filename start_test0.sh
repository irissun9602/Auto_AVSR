...
CUDA_VISIBLE_DEVICES="${mig_uuids[0]}" python multi_demo_test_mig.py data.modality='video' \
  pretrained_model_path="${pretrained_model_path}" \
  file_path="filelist/filelist000.txt" \
  csv_file="test000.csv" \
  mig_uuid="${mig_uuids[0]}" &

CUDA_VISIBLE_DEVICES="${mig_uuids[1]}" python multi_demo_test_mig.py data.modality='video' \
  pretrained_model_path="${pretrained_model_path}" \
  file_path="filelist/filelist001.txt" \
  csv_file="test001.csv" \
  mig_uuid="${mig_uuids[1]}" &

CUDA_VISIBLE_DEVICES="${mig_uuids[2]}" python multi_demo_test_mig.py data.modality='video' \
  pretrained_model_path="${pretrained_model_path}" \
  file_path="filelist/filelist002.txt" \
  csv_file="test002.csv" \
  mig_uuid="${mig_uuids[2]}" &

CUDA_VISIBLE_DEVICES="${mig_uuids[3]}" python multi_demo_test_mig.py data.modality='video' \
  pretrained_model_path="${pretrained_model_path}" \
  file_path="filelist/filelist003.txt" \
  csv_file="test003.csv" \
  mig_uuid="${mig_uuids[3]}" &
CUDA_VISIBLE_DEVICES="${mig_uuids[4]}" python multi_demo_test_mig.py data.modality='video' \
  pretrained_model_path="${pretrained_model_path}" \
  file_path="filelist/filelist004.txt" \
  csv_file="test004.csv" \
  mig_uuid="${mig_uuids[4]}" &

CUDA_VISIBLE_DEVICES="${mig_uuids[5]}" python multi_demo_test_mig.py data.modality='video' \
  pretrained_model_path="${pretrained_model_path}" \
  file_path="filelist/filelist005.txt" \
  csv_file="test005.csv" \
  mig_uuid="${mig_uuids[5]}" &

CUDA_VISIBLE_DEVICES="${mig_uuids[6]}" python multi_demo_test_mig.py data.modality='video' \
  pretrained_model_path="${pretrained_model_path}" \
  file_path="filelist/filelist006.txt" \
  csv_file="test006.csv" \
  mig_uuid="${mig_uuids[6]}" &
